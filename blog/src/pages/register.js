...
function RegisterPage(props) {
    ...
    const onSubmitHandler = (event) => {
        ...
        fetch("http://43.200.162.100/member/login/add", {
  method: "POST",
  headers: {
  ...
  body: JSON.stringify(raw),
    ...
    return (
        ...
        <Button onClick={()=>{setOpen(true);}}>약관보기</Button>
        </Grid>
        <Dialog open={Open}>
            <DialogContent>제 1 장 총 칙
...
① 이 약관은 서비스 화면이나 기타의 방법으로 이용고객에게 공지함으로써 효력을 발생합니다.<br></br>
...
① 회원 : 사이트와 서비스 이용계약을 체결하거나 이용자 아이디(ID)를 부여받은 개인 또는 단체를 말합니다.<br></br>
② 신청자 : 회원가입을 신청하는 개인 또는 단체를 말합니다.<br></br>
③ 아이디(ID) : 회원의 식별과 서비스 이용을 위하여 회원이 정하고 사이트가 승인하는 문자와 숫자의 조합을 말합니다.<br></br>
④ 비밀번호 : 회원이 부여 받은 아이디(ID)와 일치된 회원임을 확인하고, 회원 자신의 비밀을 보호하기 위하여 회원이 정한 문자와 숫자의 조합을 말합니다.<br></br>
...
① 이용약관 하단의 동의 버튼을 누르면 이 약관에 동의하는 것으로 간주됩니다.<br></br>
② 이용계약은 서비스 이용희망자의 이용약관 동의 후 이용 신청에 대하여 사이트가 승낙함으로써 성립합니다.<br></br>
<br></br>
<br></br>
<br></br>
제 5 조 (이용신청)<br></br>
① 신청자가 본 서비스를 이용하기 위해서는 사이트 소정의 가입신청 양식에서 요구하는 이용자 정보를 기록하여 제출해야 합니다.<br></br>
② 가입신청 양식에 기재하는 모든 이용자 정보는 모두 실제 데이터인 것으로 간주됩니다. 실명이나 실제 정보를 입력하지 않은 사용자는 법적인 보호를 받을 수 없으며, 서비스의 제한을 받을 수 있습니다.<br></br>
<br></br>
<br></br>
<br></br>
제 6 조 (이용신청의 승낙)<br></br>
① 사이트는 신청자에 대하여 제2항, 제3항의 경우를 예외로 하여 서비스 이용신청을 승낙합니다.<br></br>
② 사이트는 다음에 해당하는 경우에 그 신청에 대한 승낙 제한사유가 해소될 때까지 승낙을 유보할 수 있습니다.<br></br>
가. 서비스 관련 설비에 여유가 없는 경우<br></br>
나. 기술상 지장이 있는 경우<br></br>
다. 기타 사이트가 필요하다고 인정되는 경우
<br></br>
③ 사이트는 신청자가 다음에 해당하는 경우에는 승낙을 거부할 수 있습니다.<br></br>
가. 다른 개인(사이트)의 명의를 사용하여 신청한 경우<br></br>
나. 이용자 정보를 허위로 기재하여 신청한 경우<br></br>
다. 사회의 안녕질서 또는 미풍양속을 저해할 목적으로 신청한 경우<br></br>
...
제 8 조 (사이트의 의무)<br></br>
① 사이트는 회원에게 각 호의 서비스를 제공합니다.<br></br>
가. 신규서비스와 도메인 정보에 대한 뉴스레터 발송<br></br>
나. 추가 도메인 등록시 개인정보 자동 입력<br></br>
다. 도메인 등록, 관리를 위한 각종 부가서비스<br></br>
...
<br></br>
가. 전기통신기본법 등 법률의 규정에 의해 국가기관의 요구가 있는 경우<br></br>
나. 범죄에 대한 수사상의 목적이 있거나 정보통신윤리 위원회의 요청이 있는 경우<br></br>
...
제 9 조 (회원의 의무)<br></br>
① 회원은 서비스 이용 시 다음 각 호의 행위를 하지 않아야 합니다.<br></br>
가. 다른 회원의 ID를 부정하게 사용하는 행위<br></br>
나. 서비스에서 얻은 정보를 사이트의 사전승낙 없이 회원의 이용 이외의 목적으로 복제하거나 이를 변경, 출판 및 방송 등에 사용하거나 타인에게 제공하는 행위
<br></br>
다. 사이트의 저작권, 타인의 저작권 등 기타 권리를 침해하는 행위<br></br>
라. 공공질서 및 미풍양속에 위반되는 내용의 정보, 문장, 도형 등을 타인에게 유포하는 행위<br></br>
마. 범죄와 결부된다고 객관적으로 판단되는 행위<br></br>
바. 기타 관계법령에 위배되는 행위<br></br>
② 회원은 관계법령, 이 약관에서 규정하는 사항, 서비스 이용 안내 및 주의 사항을 준수하여야 합니다.<br></br>
...
제 10 조 (회원 아이디(ID)와 비밀번호 관리에 대한 회원의 의무)<br></br>
...
제 11 조 (서비스 제한 및 정지)<br></br>
① 사이트는 전시, 사변, 천재지변 또는 이에 준하는 국가비상사태가 발생하거나 발생할 우려가 있는 경우와 전기통신사업법에 의한 기간통신 사업자가 전기통신서비스를 중지하는 등 기타 불가항력적 사유가 있는 경우에는 서비스의 전부 또는 일부를 제한하거나 정지할 수 있습니다.<br></br>
...
<br></br>
① 이용고객이 이용제한 규정을 위반하거나 그 이용제한 기간 내에 제한 사유를 해소하지 않는 경우<br></br>
② 정보통신윤리위원회가 이용해지를 요구한 경우<br></br>
③ 이용고객이 정당한 사유 없이 의견진술에 응하지 아니한 경우<br></br>
...
<br></br>
<Button onClick={()=>{setOpen(false);}}>닫기</Button></DialogContent>
        </Dialog>
        <Button
                type="submit"
                fullWidth
